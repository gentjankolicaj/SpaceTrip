...
import io.gk.game.exceptions.BumpException;
import io.gk.game.util.CalculationUtils;
import io.gk.game.util.LogUtils;
...
public class AlienMotionFunction implements Function<Location, Location> {
	...
	private final AlienMotionFunctionType functionType;
